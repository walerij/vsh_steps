...
Route::post('/teachers/steps/{step}/', [App\Http\Controllers\StepscrudController::class,"videocontent"])->name('teachers.steps.videocontent');
Route::post('/teachers/steps/{step}/', [App\Http\Controllers\StepscrudController::class,"textcontent"])->name('teachers.steps.textcontent');
