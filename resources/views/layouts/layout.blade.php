...
<div class="wrapper">
    ...
    <div class="preloader flex-column justify-content-center align-items-center">
        <img class="animation__shake" src="{{asset('dist/img/fmap.png')}}" alt="AdminLTELogo" height="60" width="60">
    </div>

    <!-- Navbar -->
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        <!-- Left navbar links -->
        @include('includes.home.topmenu')

        <!-- Right navbar links -->
        @guest
            @include('includes.home.guest')
        @else
            @include('includes.home.user')
        @endguest
    </nav>
    <!-- /.navbar -->
